define(["../../cure-me.js"],function(_cureMe){"use strict";(0,_cureMe.Polymer)({is:"iron-request",hostAttributes:{hidden:!0/* ignoreName */ /* skipSlots */ /* ignoreName */ /* skipSlots */},properties:{/**
...
if(null===str||str===void 0||!str.toString){return""}return encodeURIComponent(str.toString().replace(/\r?\n/g,"\r\n")).replace(/%20/g,"+")},/**
   ...
   */_updateStatus:function(){this._setStatus(this.xhr.status);this._setStatusText(this.xhr.statusText===void 0?"":this.xhr.statusText)}});(0,_cureMe.Polymer)({is:"iron-ajax",/**
...
switch(this.action){case"ajaxResponse":this.dispatchEvent(new CustomEvent("ajax-response",{bubbles:!0,composed:!0,detail:{data,loading:!0}}));break;case"bookSlot":this.dispatchEvent(new CustomEvent("book-slot",{bubbles:!0,composed:!0,detail:{data,loading:!0}}));break;default:}}_handleError(event){//All the response has been handled through switch case by dispatching event details to the parent
