define(["./cure-me.js","./shared/api/ajax-call.js"],function(_cureMe,_ajaxCall){"use strict";(0,_cureMe.Polymer)({is:"iron-a11y-keys",behaviors:[_cureMe.IronA11yKeysBehavior],properties:{/** @type {?Node} */target:{type:Object,observer:"_targetChanged"},/**
    ...
    `}static get properties(){return{message:{type:String,value:""},visible:{type:String,value:/* ignoreName */ /* ignoreName */!1/* skipSlots */ /* skipSlots */ /* skipSlots */ /* skipSlots */},otp:{type:String,value:""}}}/**
     ...
     */_sendOtp(){const mobileNumber=this.$.mobileNumber.value;if(10==mobileNumber.length){this.visible=!0;let postObj={mobileNumber:parseInt(mobileNumber)};this.$.ajax._makeAjaxCall("post",`${baseUrl}/cureme/users`,postObj,"")}else{this.message="enter valid mobile no.";this.$.toast.open()}}/**
     * 
     * @param {*} event 
