...
switch(this.action){case"ajaxResponse":this.dispatchEvent(new CustomEvent("ajax-response",{bubbles:!0/* ignoreName */ /* skipSlots */,composed:!0,detail:{data,loading:!0}}));break;case"bookSlot":this.dispatchEvent(new CustomEvent("book-slot",{bubbles:!0,composed:!0,detail:{data,loading:!0}}));break;default:}}_handleError(event){//All the response has been handled through switch case by dispatching event details to the parent
