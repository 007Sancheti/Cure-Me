 ...
 * @memberof Vaadin
 * @private
 */class ComboBoxOverlayElement extends _vaadinOverlay.OverlayElement{static get is(){return"vaadin-combo-box-overlay"}ready(){super.ready();const loader=document.createElement("div");loader.setAttribute("part","loader");const content=this.shadowRoot.querySelector("[part~=\"content\"]");content.parentNode.insertBefore(loader,content)}}customElements.define(ComboBoxOverlayElement.is,ComboBoxOverlayElement);/**
 * Element for internal use only.
 *
 * @memberof Vaadin
 * @private
 */class ComboBoxDropdownElement extends(0,_disableUpgradeMixin.DisableUpgradeMixin)((0,_class.mixinBehaviors)(_ironResizableBehavior.IronResizableBehavior,_polymerElement.PolymerElement)){static get template(){return _htmlTag.html`
    <style>
      :host {
        display: block;
      }
...
`}static get is(){return"vaadin-combo-box-dropdown"}static get properties(){return{opened:{type:Boolean,observer:"_openedChanged"},template:{type:Object,notify:!0/* ignoreName */ /* skipSlots */},/**
...
this.dispatchEvent(new CustomEvent("position-changed"))}}customElements.define(ComboBoxDropdownElement.is,ComboBoxDropdownElement)});