define(["../../../@polymer/polymer/polymer-element.js","../../vaadin-themable-mixin/vaadin-themable-mixin.js","../../../@polymer/polymer/lib/utils/html-tag.js"],function(_polymerElement,_vaadinThemableMixin,_htmlTag){"use strict";/**
@license
 ...
 * @private
 */class ComboBoxItemElement extends(0,_vaadinThemableMixin.ThemableMixin)(_polymerElement.PolymerElement){static get template(){return _htmlTag.html`
    <style>
      :host {
        display: block;
      }
...
this.$.content.textContent=label}}_updateTemplateInstanceVariable(variable,value,_itemTemplateInstance){if(variable===void 0||value===void 0||_itemTemplateInstance===void 0){return}_itemTemplateInstance[variable]=value}}customElements.define(ComboBoxItemElement.is,ComboBoxItemElement)});