define(["../../../@polymer/polymer/polymer-element.js","../../../@polymer/polymer/lib/elements/dom-repeat.js","../../../@polymer/polymer/lib/mixins/gesture-event-listeners.js","./vaadin-date-picker-helper.js","../../vaadin-themable-mixin/vaadin-themable-mixin.js","../../../@polymer/polymer/lib/utils/html-tag.js"],function(_polymerElement,_domRepeat,_gestureEventListeners,_vaadinDatePickerHelper,_vaadinThemableMixin,_htmlTag){"use strict";/**
@license
 ...
 * @memberof Vaadin
 * @private
 */class MonthCalendarElement extends(0,_vaadinThemableMixin.ThemableMixin)((0,_gestureEventListeners.GestureEventListeners)(_polymerElement.PolymerElement)){static get template(){return _htmlTag.html`
    <style>
      :host {
        display: block;
      }
