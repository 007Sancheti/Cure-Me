define(["exports","../../vaadin-themable-mixin/vaadin-themable-mixin.js","../../vaadin-control-state-mixin/vaadin-control-state-mixin.js","../../../@polymer/polymer/lib/utils/async.js","../../../@polymer/polymer/lib/utils/debounce.js"],function(_exports,_vaadinThemableMixin,_vaadinControlStateMixin,_async,_debounce){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0/* ignoreName */ /* skipSlots */});_exports.TextFieldMixin=void 0;/**
@license
...
*/const $_documentContainer=document.createElement("template");$_documentContainer.innerHTML=`<dom-module id="vaadin-text-field-shared-styles">
  <template>
    <style>
       ...
       */autoselect:{type:Boolean,value:/* ignoreName */!1/* skipSlots */ /* skipSlots */},/**
...
this.setAttribute("input-prevented","");this._inputDebouncer=_debounce.Debouncer.debounce(this._inputDebouncer,_async.timeOut.after(200),()=>{this.removeAttribute("input-prevented")});return}}if(!e.__fromClearButton){this.__userInput=!0}this.value=e.target.value}// NOTE(yuriy): Workaround needed for IE11 and Edge for proper displaying
