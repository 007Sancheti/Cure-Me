define(["../../cure-me.js"],function(_cureMe){"use strict";function _templateObject_98cdcf504e2611ea968e0b510ccc7207(){var data=babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host {\n          display: block;\n        }\n      </style>\n    <iron-ajax id=\"ajax\" on-response=\"_handleResponse\" on-error=\"_handleError\" handle-as=\"json\" content-type=\"application/json\"> </iron-ajax>\n    "]);_templateObject_98cdcf504e2611ea968e0b510ccc7207=function _templateObject_98cdcf504e2611ea968e0b510ccc7207(){return data};return data}(0,_cureMe.Polymer)({is:"iron-request",hostAttributes:{hidden:!0/* ignoreName */ /* skipSlots */ /* ignoreName */ /* skipSlots */},properties:{/**
...
if(null===str||str===void 0||!str.toString){return""}return encodeURIComponent(str.toString().replace(/\r?\n/g,"\r\n")).replace(/%20/g,"+")},/**
   ...
   */_updateStatus:function _updateStatus(){this._setStatus(this.xhr.status);this._setStatusText(this.xhr.statusText===void 0?"":this.xhr.statusText)}});(0,_cureMe.Polymer)({is:"iron-ajax",/**
...
this.fire("iron-ajax-error",{request:request,error:error},{bubbles:this.bubbles,composed:!0});this.fire("error",{request:request,error:error},{bubbles:this.bubbles,composed:!0})},_discardRequest:function _discardRequest(request){var requestIndex=this.activeRequests.indexOf(request);if(-1<requestIndex){this.splice("activeRequests",requestIndex,1)}},_requestOptionsChanged:function _requestOptionsChanged(){this.debounce("generate-request",function(){if(null==this.url){return}if(this.auto){this.generateRequest()}},this.debounceDuration)}});var AjaxCall=/*#__PURE__*/function(_PolymerElement){babelHelpers.inherits(AjaxCall,_PolymerElement);function AjaxCall(){babelHelpers.classCallCheck(this,AjaxCall);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(AjaxCall).apply(this,arguments))}babelHelpers.createClass(AjaxCall,[{key:"_makeAjaxCall",/**
    ...
    **/value:function _makeAjaxCall(method,url,obj,action){var ajax=this.$.ajax;this.action=action;ajax.body=obj?JSON.stringify(obj):void 0;ajax.method=method;ajax.url=url;ajax.generateRequest()}/**
     * @description: Fired everytime when ajax call is made.It handles response of the ajax 
     * @param {*} event 
     */},{key:"_handleResponse",value:function _handleResponse(event){var data=event.detail.response;console.log(data);console.log(this.action);//All the response has been handled through switch case by dispatching event details to the parent
switch(this.action){case"ajaxResponse":this.dispatchEvent(new CustomEvent("ajax-response",{bubbles:!0,composed:!0,detail:{data:data,loading:!0}}));break;case"bookSlot":this.dispatchEvent(new CustomEvent("book-slot",{bubbles:!0,composed:!0,detail:{data:data,loading:!0}}));break;default:}}},{key:"_handleError",value:function _handleError(event){//All the response has been handled through switch case by dispatching event details to the parent
var data=event.detail.request.response;console.log(data);switch(this.action){case"ajaxResponse":this.dispatchEvent(new CustomEvent("ajax-response",{bubbles:!0,composed:!0,detail:{data:data}}));break;}}}],[{key:"template",get:function get(){return(0,_cureMe.html$1)(_templateObject_98cdcf504e2611ea968e0b510ccc7207())}},{key:"properties",get:function get(){return{}}}]);return AjaxCall}(_cureMe.PolymerElement);window.customElements.define("ajax-call",AjaxCall)});